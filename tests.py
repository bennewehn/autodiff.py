...
class TestVariable(unittest.TestCase):
    ...
    def test_matMul(self):
        ...
        self.assertTrue(np.array_equal(a.grad, b.data), "Grad of a should be b")
        self.assertTrue(np.array_equal(b.grad, a.data), "Grad of b should be a")
    ...
    def test_add(self):
        ...
        self.assertTrue(np.array_equal(a.grad, np.ones_like(a.data)), "Grad should be ones")
        self.assertTrue(np.array_equal(b.grad, np.ones_like(b.data)), "Grad should be ones")
    ...
    def test_add_matmul2(self):
        ...
        self.assertTrue(np.array_equal(d.grad, a.data+b.data+c.data), "Should be a+b+c")
    ...
    def test_neg1(self):
        ...
        self.assertTrue(np.array_equal(a.grad, -1*np.ones_like(a.data)), "Should be neg ones")
    ...
    def test_sum(self):
        ...
        self.assertTrue(np.array_equal(a.grad, [6]), "Should be 6")
        self.assertTrue(np.array_equal(b.grad, [2, 2, 2]), "Should be twos")
        self.assertTrue(np.array_equal(x.grad, np.ones_like(b.data)), "Should be ones")
